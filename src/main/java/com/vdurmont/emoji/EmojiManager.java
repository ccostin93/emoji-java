...
public final class EmojiManager {
    ...
    private static final Map<String, Set<Emoji>> EMOJIS_BY_TAG = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    private static final List<Emoji> ALL_EMOJIS;
    static final EmojiTrie EMOJI_TRIE;

    static {
        try {
            final InputStream stream = EmojiLoader.class.getResourceAsStream(PATH);
    ...
    public static boolean isEmoji(final String string) {
        ...
        final EmojiParser.UnicodeCandidate unicodeCandidate = EmojiParser.getNextUnicodeCandidate(string.toCharArray(), 0);
