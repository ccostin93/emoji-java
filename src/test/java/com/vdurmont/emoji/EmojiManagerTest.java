...
public class EmojiManagerTest {
    ...
    public void getForTag_with_unknown_tag_returns_null() {
        ...
        // WHEN
        final Set<Emoji> emojis = EmojiManager.getForTag("jkahsgdfjksghfjkshf");
    ...
    public void getForTag_returns_the_emojis_for_the_tag() {
        ...
        // WHEN
        final Set<Emoji> emojis = EmojiManager.getForTag("happy");
    ...
    public void getForTag_returns_the_eu_emoji_for_same_tag() {
        ...
        // WHEN
        final Set<Emoji> emojis = EmojiManager.getForTag("european union");
    ...
    public void getForAlias_with_unknown_alias_returns_null() {
        ...
        // WHEN
        final Emoji emoji = EmojiManager.getForAlias("jkahsgdfjksghfjkshf");
    ...
    public void getForAlias_returns_the_emoji_for_the_alias() {
        ...
        // WHEN
        final Emoji emoji = EmojiManager.getForAlias("smile");
    ...
    public void isEmoji_for_an_emoji_returns_true() {
        ...
        // WHEN
        final boolean isEmoji = EmojiManager.isEmoji(emoji);
    ...
    public void isEmoji_for_a_non_emoji_returns_false() {
        ...
        // WHEN
        final boolean isEmoji = EmojiManager.isEmoji(str);
    ...
    public void containsEmoji_with_fitzpatric_modifier_returns_true() {
        ...
        // WHEN
        final boolean containsEmoji = EmojiManager.containsEmoji(emoji);
    ...
    public void containsEmoji_for_a_non_emoji_returns_false() {
        ...
        // WHEN
        final boolean containsEmoji = EmojiManager.containsEmoji(str);
    ...
    public void isOnlyEmojis_for_an_emoji_returns_true() {
        ...
        // WHEN
        final boolean isEmoji = EmojiManager.isOnlyEmojis(str);
    ...
    public void getAllTags_returns_the_tags() {
        ...
        // WHEN
        final Collection<String> tags = EmojiManager.getAllTags();
    ...
    public void getAll_doesnt_return_duplicates() {
        ...
        // WHEN
        final Collection<Emoji> emojis = EmojiManager.getAll();

        // THEN
        final Set<String> unicodes = new HashSet<String>();
    ...
    public void getByUnicode_returns_correct_emoji() {
        ...
        final Emoji e = EmojiManager.getByUnicode(wavingHand);
